...
class PurchaseOrderShipment(models.Model):
    ...
    purchase_id = fields.Many2one('purchase.order', string='Purchase Reference', required=True,
    ...
    port_departure = fields.Char(string='Port of Departure')
    port_arrival = fields.Char(string='Port of Arrival',default="Hong Kong")
...
class PurchaseOrderShipmentLine(models.Model):
    ...
    x_sh_cartoon = fields.Integer(string="Cartoon",default=1)
    x_sh_product_standard_weight = fields.Float(string="Packing Spec (kg/pack)",default=10.8)
