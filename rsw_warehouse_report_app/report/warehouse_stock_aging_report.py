...
class StockAgingWoutMovementReport(models.AbstractModel):
	_name = 'report.warehouse_report_app.report_stockagingwoutmovementinfo' 
...
# Location
	...
	def _get_report_values(self, docids, data=None):
		...
		docargs = {
				   'doc_model': 'stock.aging.warehouse.wout.movement',
				   'data': data,
