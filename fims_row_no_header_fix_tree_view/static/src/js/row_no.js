odoo.define('fims_row_no_header_fix_tree_view.row_in_list', function (require) {
    "use strict";
    ...
    ListRenderer.include({
        ...
        _renderHeader: function (isGrouped) {
        	...
        	if (this.hasSelectors) {
        		$header.find("th.o_list_record_selector").before($('<th class="o_list_row_number_header o_list_row_count_fims">').html('#'));
